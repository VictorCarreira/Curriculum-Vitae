...
!Entradas
open(1,file='../inputs/Sintetico/BD_convolvido.txt')! Banco de Dados
open(2,file='../inputs/Sintetico/C3_convolvido.txt') !Dado a ser classificado.

!Saidas: mapas
open(3,file='../outputs/Sintetico/C3_SOM1_convolvido.txt')
open(4,file='../outputs/Sintetico/C3_SOM2_convolvido.txt') ! mapas: neurônios visitados, props., e litos.
open(5,file='../outputs/Sintetico/C3_SOM3_convolvido.txt')
!Saidas: convergência e modelo classificado
open(7,file='../outputs/Sintetico/C3_CONV_convolvido.txt')! convergência
open(8,file='../outputs/Sintetico/well_C3_SOM_convolvido.txt')  ! classificacao
...
!read(1,15) cab    ! linha em branco abaixo do cabeçalho. Retira-se essa linha do dado convolvido. 
...
open(2,file='../inputs/Sintetico/C3_convolvido.txt')
 read(2,15) cab    ! cabeçalho
! read(2,15) cab    ! linha em branco abaixo do cabeçalho
