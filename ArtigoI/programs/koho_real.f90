...
!Entradas
open(1,file='../inputs/Real/BD_real_filtrado.txt')! Banco de Dados
open(2,file='../inputs/Real/classificacao1API0001.txt') !Dado a ser classificado.

!Saidas: mapas
open(3,file='../outputs/Real/REAL_SOM1_norm_minmax.txt')
open(4,file='../outputs/Real/REAL_SOM2_norm_minmax.txt') ! mapas: neurônios visitados, props., e litos.
open(5,file='../outputs/Real/REAL_SOM3_norm_minmax.txt')
!Saidas: convergência e modelo classificado
open(7,file='../outputs/Real/REAL_CONV_norm_minmax.txt')! convergência
open(8,file='../outputs/Real/REAL_SOM_classificacao_norm_minmax.txt')  ! classificacao
...
open(1,file='../inputs/Real/BD_real_filtrado.txt')
...
! construção do tabuteiro - configuração inicial randômica
 ...
 nta=120   !20 ! número de neurônios em cada lado do tabuleiro
