PROGRAM Estatisticos
  ...
  CALL CPU_TIME(inicio)
   ...
   OPEN(1,FILE='../inputs/Sintetico/BDsintetico.txt')
   OPEN(2,FILE='../inputs/Sintetico/C3.txt')
   OPEN(3,FILE='../outputs/Sintetico/Result_eucli_C3.txt')
   OPEN(4,FILE='../outputs/Sintetico/Result_maha_C3.txt')
