PROGRAM kohonen
 ...
 IMPLICIT NONE
  ...
  CHARACTER(LEN=80):: cab, litologia, tic
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!Entradas
  OPEN(1,FILE='../inputs/dados_sint_T1.txt')! Cria o arquivo dados-treinamento e armazena na unidade 1
  OPEN(2,FILE='../inputs/dados_sint_c1.txt')! Cria o arquivo entrada e armazena na unidade de memória 2
!Saidas
...
DO i=1,nt
  READ(1,*) litologia,cl(i),tr(i,1),tr(i,2),tr(i,3),tr(i,4)
END DO 
CLOSE(1)
...
!Construção da geometria da rede (tabuleiro de vizinhos e competição)
 ...
 c4max=res2(4)!5.88d0 ! Valor máximo da propriedade 4
   ...
   nta=40    ! número de neorônios em cada lado do tabuleiro 
