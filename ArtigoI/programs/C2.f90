...
print*,'**************** Poço C2 ********************'
  ...
  vp(4,1)=60d0!sonico
	...
	delta(1,1)=vp(1,1)*0.5d0
	delta(2,1)=vp(2,1)*0.5d0
	delta(3,1)=vp(3,1)*0.5d0
	delta(4,1)=vp(4,1)*0.5d0
...
!cccccc  camada 2  cccccccccccccccccccccc
 ...
 vp(4,2)=70d0!DT
	...
	delta(1,2)=vp(1,2)*0.5d0
	delta(2,2)=vp(2,2)*0.5d0
	delta(3,2)=vp(3,2)*0.5d0
	delta(4,2)=vp(4,2)*0.5d0
...
!cccccccccc  camada 3   ccccccccccccccccccccccc
  ...
  vp(4,3)=50d0!DT
	...
	delta(1,3)=vp(1,3)*0.5d0
	delta(2,3)=vp(2,3)*0.5d0
	delta(3,3)=vp(3,3)*0.5d0
	delta(4,3)=vp(4,3)*0.5d0

	cota3=1.0d0
	esp3=cota3-cota2
	T_amostra=1d-2
	nd(3)=int(esp3/T_amostra)   !numero de medidas na camada 3
	write(6,*) 'nd(c2-diabasio)=',nd(3)
...
!ccccccccc   camada 4 cccccccccccccccccccccc
 ...
 vp(4,4)=70d0!DT
	...
	delta(1,4)=vp(1,4)*0.5d0
	delta(2,4)=vp(2,4)*0.5d0
	delta(3,4)=vp(3,4)*0.5d0
	delta(4,4)=vp(4,4)*0.5d0
...
!ccccccccc   camada 5 cccccccccccccccccccccc
 ...
 vp(4,5)=50d0!DT
	...
	delta(1,5)=vp(1,5)*0.5d0
	delta(2,5)=vp(2,5)*0.5d0
	delta(3,5)=vp(3,5)*0.5d0
	delta(4,5)=vp(4,5)*0.5d0
	...
	write(6,*) 'nd(c2-conglomerado)=',nd(5)
...
!ccccccccc   camada 6 Ultima camada cccccccccccccccccccccc
 ...
 vp(4,6)=5d0!DT
	...
	delta(1,6)=vp(1,6)*0.5d0
	delta(2,6)=vp(2,6)*0.5d0
	delta(3,6)=vp(3,6)*0.5d0
	delta(4,6)=vp(4,6)*0.5d0
	...
	write(6,*) 'nd(c2-embasamento)=',nd(6)
