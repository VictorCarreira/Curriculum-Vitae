...
!Entradas
open(1,file='../inputs/Real/mardonorte_treinamento.txt')! Banco de Dados
open(2,file='../inputs/Real/mardonorte_validacao.txt') !Dado a ser classificado.

!Saidas: mapas
open(3,file='../outputs/Real/SOM1_mardonorte.txt')
open(4,file='../outputs/Real/SOM2_mardonorte.txt') ! mapas: neurônios visitados, props., e litos.
open(5,file='../outputs/Real/SOM3_mardonorte.txt')
!Saidas: convergência e modelo classificado
open(7,file='../outputs/Real/CONV_mardonorte.txt')! convergência
open(8,file='../outputs/Real/RESULT_mardonorte.txt')  ! classificacao
...
open(1,file='../inputs/Real/mardonorte_treinamento.txt')
...
open(2,file='../inputs/Real/mardonorte_validacao.txt')
 read(2,15) cab    ! cabeçalho
 read(2,15) cab    ! linha em branco abaixo do cabeçalho
